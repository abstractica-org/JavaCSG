...
/**
 * Represents an immutable three-dimensional geometric entity.
 * <p>
...
public interface Geometry3D extends Geometry
{
	 ...
	 * </p>
	 *
	 * @return the minimum coordinate as a {@link Vector3D}
	 */
	Vector3D getMin();
	 ...
	 * </p>
	 *
	 * @return the maximum coordinate as a {@link Vector3D}
	 */
	Vector3D getMax();
}
